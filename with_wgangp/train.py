...
from model import Discriminator_VGG_128, RRDBNet
...
def train(hr_dir, lr_dir):
    ...
    netG = RRDBNet(in_nc=CHANNELS_IMG, out_nc=CHANNELS_IMG, nf=64, nb=23).to(device)

    netD = Discriminator_VGG_128(in_nc=CHANNELS_IMG, nf=64).to(device)
